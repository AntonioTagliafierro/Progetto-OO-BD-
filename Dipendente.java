...
public class Dipendente {
	...
	public Dipendente(String codiceFiscale, String nome, String cognome, String email, Date dataNascita,
			String status, String sesso, String nCellulare,float valutazione, float salarioMedio, String pathFoto, Residenza residenza) {
		super();
		this.codiceFiscale = codiceFiscale;
		this.nome = nome;
		this.cognome = cognome;
	...
	public Dipendente(String codiceFiscale, String nome, String cognome, String email, Date dataNascita,
			String status,String sesso, float valutazione, float salarioMedio, String pathFoto, Residenza residenza,
